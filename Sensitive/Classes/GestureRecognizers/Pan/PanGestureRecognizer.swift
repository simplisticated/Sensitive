...
public class PanGestureRecognizer: UIPanGestureRecognizer {
    ...
    public init(handlerBlock: @escaping GestureRecognizerHandlerBlock<UIPanGestureRecognizer>) {
        super.init(target: nil, action: nil)
        
        // Add target
        
        addTarget(self, action: #selector(PanGestureRecognizer.runHandlerBlock))
    ...
    fileprivate var _handlerBlock: GestureRecognizerHandlerBlock<UIPanGestureRecognizer>!
    
    fileprivate var handlerBlock: GestureRecognizerHandlerBlock<UIPanGestureRecognizer> {
        get {
